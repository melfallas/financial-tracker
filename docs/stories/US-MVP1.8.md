...
- [ ] All three inputs default to `1` on blur if empty/zero.
- [ ] Unit test for blur-auto-correct behavior.
- [ ] Amount display column has fixed width; left params never shift.
- [ ] Layout stable at $100, $1K, $10K, $100K values.
