...
- [x] Components use Angular 21 Signals for reactivity.
- [x] Charts implemented with Chart.js (+ ng2-charts if applicable).
- [x] Responsive design verified (Mobile/Tablet/Desktop).
- [x] Interactive elements covered by unit tests (Vitest).
- [x] Stories created in Storybook for all new organisms.
- [x] Design adheres to the Premium Aesthetic (Emerald/Deep Blue).
...
4. **Emotional Urgency:** Implement the Cost of Waiting Banner (US4.2) as a derived data view.
