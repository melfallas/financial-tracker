...
_Foundational documents defining the "Why" and "What" of the project._

- **[PRD.md](./PRD.md)**: Product Requirements Document. Goals, user personas, and core features.
- **[Backlog.md](./Backlog.md)**: **Active Roadmap** — Master list of user stories, epics, and current status. **(Consult before planning)**.
...
- **[Dependency-Analysis.md](./Dependency-Analysis.md)**: **Strategic Roadmap** — Mermaid tree, Golden Path sequence, and execution constraints. **(Consult before starting any feature)**.
- **[PO_Checklist.md](./PO_Checklist.md)**: **Quality Guard** — Checklist for Product Owner validation and acceptance criteria. **(Consult for compliance)**.
- **[SprintReport.md](./SprintReport.md)**: **Progress Report** — History and current status of sprints and velocity. **(Consult for status)**.

---

### 🏛️ Architectural Rules (Core Config)

- **Consultation Mandatory:** All feature planning MUST consult the **Strategic Layer** documents above to ensure alignment with dependencies and priorities.
- **JSON Standard:** All proposed API or Mock JSON files must maintain **snake_case** format.
- **Artifact Sync:** Any update to features must ensure that the corresponding state in `PROJECT_INDEX.md`, `Backlog.md`, and `SprintReport.md` is updated.
...
_Technical standards, structure, and data persistence strategies._
...
_Design system, visual specifications, and interaction physics._
...
_Configuration and tooling for the project._
...
_— Generated by BMAD Team (John, Winston, Sally) · 2026-02-22_
