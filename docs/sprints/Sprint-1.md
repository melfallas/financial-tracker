...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **US1.1** | [Project Initialization](../stories/US1.1.md) | P0 | Medium | Angi (Dev) | 📂 TODO |
| **US1.2** | [Global Design System](../stories/US1.2.md) | P0 | Medium | Angi (Dev) | 📂 TODO |
| **US1.3** | [Storybook Setup](../stories/US1.3.md) | P1 | Small | Angi (Dev) | 📂 TODO |
| **US1.4** | [Wealth Gap Engine (TDD)](../stories/US1.4.md) | P0 | High | Angi (Dev) | 📂 TODO |
